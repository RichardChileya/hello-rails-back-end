...
**[Rails Backend]** is a full stack web app with which a user can add basic budget items and monitor their spendings, the application allows users to enter items and amounts to be spent on every item
...
```sh
  cd my-folder
  git clone https://github.com/RichardChileya/hello-rails-back-end.git
  cd budget-app
```
### Install
...
Feel free to check the [issues page](https://github.com/RichardChileya/hello-rails-back-end/issues).
